...
const template = Template()
  ...
  .runCmd([
    ...
    `npm install --prefix ${shellQuote(buildToolsDir)} --no-save vite@5.4.14 @vitejs/plugin-react@4.3.4`,
    ...
    `rm -rf ${shellQuote(`${installDir}/node_modules/vite`)} ${shellQuote(`${installDir}/node_modules/@vitejs`)} ${shellQuote(buildToolsDir)}`,
